...
class RadarSweepPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint paintCircle = Paint()
      ..color = const Color(0xFFCCFF00).withValues(alpha: 0.06) // Lime green pulse lines
    ...
    final Paint sweepPaint = Paint()
      ..color = const Color(0xFFCCFF00).withValues(alpha: 0.12) // Neon lime green sweep
    ...
    final Paint glowPaint = Paint()
      ..shader = RadialGradient(
        colors: [
          const Color(0xFFCCFF00).withValues(alpha: 0.08),
    ...
    final Paint paintGreenDot = Paint()..color = const Color(0xFF22C55E).withValues(alpha: dotOpacity);
    final Paint paintGreenRing = Paint()
      ..color = const Color(0xFF22C55E).withValues(alpha: ringOpacity)
      ..style = PaintingStyle.stroke
      ..strokeWidth = 1.0;
