...
.sched-badge { display: inline-flex; align-items: center; gap: 4px; padding: 2px 6px; border-radius: 6px; font-size: 11px; font-weight: 700; text-transform: uppercase; background: #FFF7ED; color: #F97316; }
`;

export default function UpcomingServicesPage() {
  const services = [
    { id: 'SRV-8271', vehicle: 'EV-12KA-1234', type: 'Brake Fluid Flush', date: 'May 20, 2024', status: 'scheduled' },
    { id: 'SRV-8272', vehicle: 'EV-12KA-5678', type: 'Tire Thread Check', date: 'May 22, 2024', status: 'scheduled' },
    { id: 'SRV-8274', vehicle: 'EV-12KA-6789', type: 'Battery health assessment', date: 'May 25, 2024', status: 'scheduled' },
    { id: 'SRV-8275', vehicle: 'EV-12KA-9012', type: 'GPS module verification', date: 'May 28, 2024', status: 'scheduled' }
  ];
    ...
    <>
      ...
      <div className="mn-shell">
        ...
        <div className="mn-main">
          <TopBar title="Upcoming Services" subtitle="Track upcoming inspections and preventative checks." showHand={false} />
            ...
            <div className="mn-stats-row">
              <div className="mn-stat-card">
                ...
                <div className="mn-stat-info">
                  <span className="mn-stat-lbl">Scheduled Checks</span>
                  <span className="mn-stat-val">12</span>
                </div>
              </div>
              <div className="mn-stat-card">
                <span className="mn-stat-ic ic-yellow">⚙</span>
                <div className="mn-stat-info">
                  <span className="mn-stat-lbl">Routine Checks</span>
              ...
              <div className="mn-stat-card">
                ...
                <div className="mn-stat-info">
                  <span className="mn-stat-lbl">On Time</span>
                  <span className="mn-stat-val">12</span>
                </div>
              </div>
              <div className="mn-stat-card">
                ...
                <div className="mn-stat-info">
                  <span className="mn-stat-lbl">High Priority</span>
                ...
                <tbody>
                  {services.map(s => (
                    <tr key={s.id}>
                      ...
                      <td>{s.date}</td>
                      <td>
                        <span className="sched-badge">{s.status}</span>
                      </td>
                    </tr>
                  ))}
                </tbody>
