      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              // --- 1. TOP HEADER BAR (MENU, BRAND LOGO, BELL & PROFILE AVATAR) ---
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Row(
                      children: [
                        const Icon(Icons.menu_rounded, color: Color(0xFF200F54), size: 24),
                        const SizedBox(width: 12),
                        Image.asset(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Stack(
                              children: [
                                const Icon(Icons.notifications_none_rounded, color: Color(0xFF200F54), size: 20),
                                Positioned(
                                  right: 0,
                                  top: 0,
                                  child: Container(
                        ...
                        // Avatar Pill with Online Status Dot
                        Stack(
                          children: [
                            Container(
                              width: 36,
                              ...
                              child: const Icon(Icons.person_rounded, color: Color(0xFF4313B8), size: 20),
                            ),
                            Positioned(
                              right: 0,
                              bottom: 0,
