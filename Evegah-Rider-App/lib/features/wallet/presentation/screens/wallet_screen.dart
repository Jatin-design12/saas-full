...
class _WalletScreenState extends State<WalletScreen> {
  ...
  Future<void> _fetchRealTransactions() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == 'success' && data['data'] != null) {
          ...
          for (var r in dbList) {
            ...
            final double total = double.tryParse("${r['total_amount'] ?? r['total_payable'] ?? (fare + deposit)}") ?? (fare + deposit);
            final String dateStr = r['reservation_date'] != null ? r['reservation_date'].toString().split('T').first : 'Recent';

            realTxList.add({
              "title": "Ride Reservation (${r['payment_status'] ?? 'Paid'})",
              "subtitle": "${r['vehicle_model'] ?? 'Evegah EV'} • ${r['pickup_zone'] ?? 'Gotri Zone'}",
              "date": "$dateStr, ${r['reservation_time'] ?? '10:00 AM'}",
      ...
      debugPrint("Error fetching real wallet transactions: $e");
    }
  ...
  void _initRazorpaySafely() {
    try {
      ...
      debugPrint("Razorpay init suppressed for unsupported platform: $e");
    }
  }
  ...
  Future<void> _startPayment(double amount) async {
    ...
    if (orderData == null) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("Failed to secure payment connection. Using mock top-up."), backgroundColor: Colors.orange),
        );
        setState(() {
    ...
    if (kIsWeb) {
      startRazorpayWebCheckout(
        keyId: orderData["keyId"] ?? 'rzp_test_TCrlW614wYWVgA',
        amount: amount,
        ...
        onFailure: (error) {
          _handlePaymentError(PaymentFailureResponse.fromMap({
            "code": 0,
            "message": error,
          }));
        },
    ...
    try {
      if (_razorpay != null) {
        ...
        // Fallback for desktop / mock testing
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Deep Purple Balance Card matching Image 2
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Row(
                      children: const [
                        Text("More", style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: Color(0xFF5B45E0))),
                        SizedBox(width: 3),
                        Icon(Icons.arrow_forward_rounded, size: 14, color: Color(0xFF5B45E0)),
                      ],
                    ),
                  ),
                ],
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Row(
                      children: const [
                        Text("View All", style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: Color(0xFF5B45E0))),
                        SizedBox(width: 3),
                        Icon(Icons.arrow_forward_rounded, size: 14, color: Color(0xFF5B45E0)),
                      ],
                    ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: _transactions.asMap().entries.map((entry) {
                    ...
                    final isLast = idx == _transactions.length - 1;
              ...
              // Bottom Banner: "Thank you for choosing EVegah!" matching Image 2
              _buildThankYouCard(),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [Color(0xFF1B0764), Color(0xFF2C10A3)],
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF2C10A3).withValues(alpha: 0.35),
            blurRadius: 16,
        ...
        children: [
          Row(
            ...
            children: [
                ...
                children: [
                  Row(
                    children: [
                      const Text(
                        "Total Balance",
                        style: TextStyle(fontSize: 13.5, fontWeight: FontWeight.w600, color: Colors.white70),
                      ),
              ...
              // 3D Purple Wallet Illustration Graphic matching Image 2
              SizedBox(
                width: 85,
                height: 75,
                child: Stack(
                  children: [
                    // Yellow Card popping out from wallet top slot
                    Positioned(
                      top: 4,
                      right: 12,
                      child: Container(
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: const LinearGradient(
                            colors: [Color(0xFF6B42F2), Color(0xFF4C27D0)],
                            begin: Alignment.topLeft,
                            end: Alignment.bottomRight,
                          ),
          ...
          // Action Buttons: + Add Money (Neon Lime) & ↗ Withdraw (Purple) matching Image 2
          Row(
            children: [
              Expanded(
              ...
              Expanded(
                child: ElevatedButton.icon(
                  onPressed: () {},
                  icon: const Icon(Icons.north_east_rounded, color: Colors.white, size: 18),
                  label: const Text(
                    "Withdraw",
                    style: TextStyle(fontWeight: FontWeight.w800, fontSize: 14.5, color: Colors.white),
                  ),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFF5A44E5),
                    elevation: 0,
                    padding: const EdgeInsets.symmetric(vertical: 14),
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
                  ),
  ...
  Widget _buildQuickActionItem(String title, IconData icon, Color iconBg, Color iconColor, VoidCallback onTap) {
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: const TextStyle(fontSize: 11.5, fontWeight: FontWeight.w700, color: Color(0xFF1E293B), height: 1.25),
            ),
          ],
        ),
      ),
  ...
  Widget _buildTransactionTile(Map<String, dynamic> item, bool isLast) {
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: isLast ? null : const Border(bottom: BorderSide(color: Color(0xFFF1F5F9), width: 1.2)),
        ),
      child: Row(
        children: [
          Container(
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                  ...
                  color: item['isCredit'] ? const Color(0xFF16A34A) : const Color(0xFF0F172A),
                ),
              ),
              const SizedBox(height: 3),
              Text(
            ...
            child: Column(
              ...
              children: const [
                ...
                Text(
                  ...
                  style: TextStyle(fontSize: 11.5, color: Color(0xFF047857), fontWeight: FontWeight.w500, height: 1.3),
                ),
              ],
            ),
          ),
          ...
          builder: (BuildContext context, StateSetter setModalState) {
            return Padding(
              ...
              child: Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("Add Money to Wallet", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: Color(0xFF0F172A))),
                  ...
                  Wrap(
                    ...
                    children: quickAmounts.map((amt) {
                      return GestureDetector(
                        onTap: () => setModalState(() => controller.text = amt.toString()),
                        child: Container(
                          ...
                          child: Text(
                            "₹$amt",
                            style: const TextStyle(color: Color(0xFF5B45E0), fontWeight: FontWeight.w800, fontSize: 13),
                          ),
                        ),
                      );
                    }).toList(),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: _isProcessingPayment
                          ? null
                          : () async {
                              final amt = double.tryParse(controller.text) ?? 500;
                              if (amt > 0) {
                                Navigator.pop(context);
                                await _startPayment(amt);
                              }
                            },
                      style: ElevatedButton.styleFrom(
                      ...
                      child: _isProcessingPayment
                          ...
                          : const Text("Proceed to Pay", style: TextStyle(fontWeight: FontWeight.w800, color: Colors.white, fontSize: 15)),
                    ),
                  ),
